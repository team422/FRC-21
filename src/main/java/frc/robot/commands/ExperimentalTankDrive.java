...
public class ExperimentalTankDrive extends CommandBase{
    ...
    public ExperimentalTankDrive(){
        setName("ExperimentalTankDrive");
    ...
    public void execute(){
        ...
        Subsystems.driveBase.cheesyDrive.tankDrive(leftSpeed, rightSpeed, true);
    }
